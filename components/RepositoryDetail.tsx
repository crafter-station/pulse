      ...
      <div className="mx-auto max-w-4xl">
        <div className="mb-8 md:mb-10">
          ...
          <p className="text-xs text-[#737373] mt-3 max-w-xl" role="note">
            Data reflects activity tracked by Pulse (webhook + backfill), not
            full GitHub history. To see the full history, visit the repo on
            GitHub.
          </p>
        </div>
              ...
              {topContributors.map((c, i) => (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <span className="text-[#737373] text-sm w-5 shrink-0">
                      {i + 1}
                    </span>
                    {c.avatarUrl ? (
                      <img
